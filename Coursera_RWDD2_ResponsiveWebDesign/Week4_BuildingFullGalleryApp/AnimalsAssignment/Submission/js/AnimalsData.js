...
var animals_data = {
	categories : [
		{
			name : "Reptiles",
			thumbnail : "http://static.tvtropes.org/pmwiki/pub/images/reptile-4_copy_9098.jpg",
			species : [
				{
					photos : [
		...
		{
			name : "Mammals",
			thumbnail : "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Mammal_Diversity_2011.png/275px-Mammal_Diversity_2011.png",
			species : [
				{
					photos : [
		...
		{
			name : "Birds",
			thumbnail : "https://naturalishistoria.files.wordpress.com/2013/11/bird_diversity_2013-wikipedia.png",
			species : [
				{
					photos : [
